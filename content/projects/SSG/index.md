...
I wrap the whole thing in one html *div* _ParentNode_. Afterwords this is converted to html syntax and feeded to the generator part of the SSG. 

For the generator I am using the _os_ and _shutil_ libraries' functionalities to first delete everything in the docs folder and then recursively map the content folder copying everything to the docs:
...
Finally, a page is generated using the converted to html version of one of the markdown files in the docs folder, a template html file, a css file and any other needed raw data (such as images):
...
After that I bulit a recursive function, that goes through all of the markdown files in the docs folder and generates them recursevely:
